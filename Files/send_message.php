...
// Get the receiver ID and message text
...
try {
    ...
    if (isset($_FILES['file']) && $_FILES['file']['error'] == UPLOAD_ERR_OK) {
        ...
        // Increased max size for videos (50MB)
        ...
        $stmt = $db->prepare("INSERT INTO messages1 (sender_id, receiver_id, message_text, file_url, file_type, created_at) VALUES (?, ?, ?, ?, ?, NOW())");
        $stmt->execute([$sender_id, $receiver_id, $message_text, $file_path, $file_mime_type]);
        ...
        $stmt = $db->prepare("INSERT INTO messages1 (sender_id, receiver_id, message_text, created_at) VALUES (?, ?, ?, NOW())");
